...
parser = OptionParser()
parser.add_option("-o", "--output", dest="output", default="C:\\Users\\Alex\\Documents\\Data\\PovCal_Increment\\world\\",
...
for i in range(1,301):
    ...
    frame.loc[frame.pl=="Survey data coverage is too low, the result is suppressed",["coverage"]] = frame.loc[frame.pl=="Survey data coverage is too low, the result is suppressed",["hc"]]
