...
dataDictionary["Mozambique"]["table3"] = [
    ...
    ,[Paragraph("Stunting",style=greyParaStyle),format(733,",d"),2015]
    ,[Paragraph("Wasting",style=greyParaStyle),format(43,",d"),2015]
    ,[Paragraph("Overweight",style=greyParaStyle),format(149,",d"),2015]
    ,["% of children under 5 affected","",""]
    ,[Paragraph("Wasting",style=greyParaStyle),format(2,"d"),2015]
    ,[Paragraph("Severe wasting",style=greyParaStyle),format(1,"d"),2015]
    ,[Paragraph("Overweight",style=greyParaStyle),format(8,"d"),2015]
    ,[Paragraph("Low birth weight",style=greyParaStyle),format(7,"d"),2015]
    ]
...
dataDictionary["Mozambique"]["table7"] = [
    ...
    ,[Paragraph("Immunisation coverage, DTP3<super>2</super>",style=greyParaStyle),"78","2016"]
...
dat = pd.read_csv("data_thailand.csv")
for country in dataDictionary.keys():
    ...
    dataDictionary[country]["table3"][5][2] = safeFormat(row["prev_wasting_year"])
    ...
    dataDictionary[country]["table3"][7][2] = safeFormat(row["prev_u5overweight_year"])
