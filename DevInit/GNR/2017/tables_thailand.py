...
dataDictionary["Mozambique"]["table3"] = [
    ...
    ,[Paragraph("Severe wasting<super>2</super>",style=greyParaStyle),format(1,"d"),2015]
    ,[Paragraph("Overweight<super>1</super>",style=greyParaStyle),format(8,"d"),2015]
    ,[Paragraph("Low birth weight<super>3</super>",style=greyParaStyle),format(7,"d"),2015]
    ]
