...
class ReportMaker(object):
    ...
    #----------------------------------------------------------------------
    def __init__(self, pdf_file, xml_file,region_name):
        ...
        for page in self.e.findall("page"):
            ...
            for text in page.findall("text"):
                if len(text.getchildren())==0:
                    ...
                    if text.get("replace"):
                        replacement = dataDictionary[self.region][text.get("replace")]
                    else:
            ...
            for table in page.findall("table"):
                self.c.setDash(1,0)
                tabDat = dataDictionary[self.region][table.get("data")]
                if table.get("widths"):
